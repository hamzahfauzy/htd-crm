                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <select name="transactions[customer_id]" class="form-control" onchange="location='index.php?r=transactions/create&customer_id='+this.value">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="transactions[business_id]" class="form-control">
                                        <option value="" selected readonly>- Pilih Bisnis -</option>
